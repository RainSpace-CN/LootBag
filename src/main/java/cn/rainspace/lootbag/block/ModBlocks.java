...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MAGIC_FROSTED_ICE = BLOCKS.register("magic_frosted_ice", () -> new MagicFrostedIceBlock(AbstractBlock.Properties.of(Material.ICE).friction(0.98F).instabreak().sound(SoundType.GLASS).noDrops()));
