...
public class LootBagItem extends Item {
  ...
  public ActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
    ...
    if(!world.isClientSide){
		...
		LootContext context = (new LootContext.Builder((ServerWorld)world)).withLuck(player.getLuck()).withParameter(LootParameters.THIS_ENTITY,player).create(LootParameterSets.CHEST);
    ...
    return world.isClientSide()?ActionResult.success(itemstack):ActionResult.consume(itemstack);
  }
}
